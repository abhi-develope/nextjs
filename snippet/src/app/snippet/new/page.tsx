...
const page = () => {
  ...
  return (
    ...
    <div className='flex justify-between   items-center'>
      ...
      <input name='title' id='title' type="text" className=' shadow-sm ml-4 w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow bg-black text-white' />
      
    </div>
    <div className='flex justify-around   items-center'>
      <label className='text-2xl font-bold'>Code:</label>
      <textarea name='code' id='code' className='bg-black text-white mt-3 shadow-lg ml-4 w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow h-[486px]'  />
